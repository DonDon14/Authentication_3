...
function initializeSidebarToggle() {
    ...
    const floatingButton = createFloatingExpandButton();
    ...
    // Handle both sidebar toggle and floating button clicks
    ...
    function createFloatingExpandButton() {
        ...
        button.className = 'sidebar-expand-float';
        button.innerHTML = '<i class="fas fa-chevron-right"></i>';
        button.setAttribute('title', 'Expand Sidebar (Ctrl+B)');
    ...
    if (window.innerWidth <= 768) {
        document.addEventListener('click', function(e) {
            if (!sidebar.contains(e.target) && !sidebarToggle.contains(e.target) && !floatingButton.contains(e.target)) {
                if (!sidebar.classList.contains('collapsed')) {
                    toggleSidebar();
                }
            }
    ...
    function updateToggleIcon(isCollapsed) {
        ...
        if (isCollapsed) {
            ...
            sidebarToggle.setAttribute('title', 'Expand Sidebar (Ctrl+B)');
        } else {
            icon.className = 'fas fa-bars';
            sidebarToggle.setAttribute('title', 'Collapse Sidebar (Ctrl+B)');
        }
    }
